...
<nav class="navbar navbar-expand-lg">
  <div class="container">
    <a class="navbar-brand" href="#"><img src="./Assests/logo.png" alt="Logo" class="img-fluid"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="course.php" title="Course.php">Course</a>
        </li>
        <!-- <li class="nav-item">
            <a href="#" class="nav-link" title="Placement">Placement</a>
        </li> -->
        <li class="nav-item">
